...
/*!
 * Konstruktor klasy. Inicjalizuje referencję na konfigurację
 * do wczytania
 */
XMLInterp4Config::XMLInterp4Config(Configuration &rConfig) : _rMainConfig(rConfig)
{
}
...
void XMLInterp4Config::ProcessLibAttrs(const xercesc::Attributes &Attrs)
{
  ...
  _rMainConfig.addLibName(sLibName);
 ...
 * \param[in] Attrs - (\b we,) atrybuty elementu XML \p "Cube".
 */
void XMLInterp4Config::ProcessCubeAttrs(const xercesc::Attributes &Attrs)
{
  ...
  */
  ...
  char *sName_Shift = xercesc::XMLString::transcode(Attrs.getQName(1));
  char *sName_Scale = xercesc::XMLString::transcode(Attrs.getQName(2));
  char *sName_RotXYZ_deg = xercesc::XMLString::transcode(Attrs.getQName(3));
  char *sName_Trans_m = xercesc::XMLString::transcode(Attrs.getQName(4));
  char *sName_RGB = xercesc::XMLString::transcode(Attrs.getQName(5));

  XMLSize_t Index = 0;
  char *sValue_Name = xercesc::XMLString::transcode(Attrs.getValue(Index));
  char *sValue_Shift = xercesc::XMLString::transcode(Attrs.getValue(1));
  char *sValue_Scale = xercesc::XMLString::transcode(Attrs.getValue(2));
  char *sValue_RotXYZ_deg = xercesc::XMLString::transcode(Attrs.getValue(3));
  char *sValue_Trans_m = xercesc::XMLString::transcode(Attrs.getValue(4));
  char *sValue_RGB = xercesc::XMLString::transcode(Attrs.getValue(5));
  ...
  _rMainConfig.addMobObject(sValue_Name, sValue_Shift, sValue_Scale, sValue_RotXYZ_deg, sValue_Trans_m, sValue_RGB);
